...
# def validatePassport(passportString):
#     requirements = [
#                     'byr',
#                     'iyr',
#                     'eyr',
...
#     passport = {} # makes a new empty dictionary
#     elements = passportString.strip().split()
...
#     return all(requirement in passport for requirement in requirements)

# def part2():
#     count=0
#     for passport in passports:
    
#         if all(requirements in passport.keys() for requiremnt in requirements):
